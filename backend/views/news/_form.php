...
<div class="news-form">
    ...
    <div class="box box-solid box-success">
        <div class="box-header">Название новости</div>
...
<!--        ])->label(false)-->
    ...
    <?= $form->field($model, 'image_big')->widget(FileInput::classname(), [
        ...
        'pluginOptions' => [
            'initialPreview' => $model->img_big ? '/uploads/news/'.$model->img_big : false,
    ...
    <?= $form->field($model, 'image_middle')->widget(FileInput::classname(), [
        ...
        'pluginOptions' => [
            'initialPreview' => $model->img_middle ? '/uploads/news/'.$model->img_middle : false,
            'initialPreviewAsData' => true,
        ],
    ]) ?>
    ...
    <?= $form->field($model, 'image_small')->widget(FileInput::classname(), [
        ...
        'pluginOptions' => [
            'initialPreview' => $model->img_small ? '/uploads/news/'.$model->img_small : false,
            'initialPreviewAsData' => true,
        ],
    ]) ?>
