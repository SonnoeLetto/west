                    ...
                    <div class="col-md-12">
                        ...
                        <div class="apply-text__wrap">
                            <p class="video-apply__text">
                                <?= Yii::t('site', 'Наші фахівці допоможуть вибрати системи відеоспостереження та швидко їх встановлять. Користуватися віддаленим відеоспостереженням зручно і просто, для цього не потрібно довго вчитися. Досить мати доступ до Інтернету.')?>

                            </p>
                            <p class="video-apply__text">
                                <?= Yii::t('site', 'Те, що транслюють відеокамери спостереження на ваш комп\'ютер, ноутбук, планшет або смартфон, ніхто не побачить і не почує, інформація проходить по захищеному каналу зв\'язку, і доступ до неї маєте тільки ви.')?>
                            </p>
                            <p class="video-apply__text">
                        ...
                        <div class="video-apply__link">
                            <a href="#" class="router__link">
                                <?= Yii::t('site', 'Подати заявку')?>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="mobile-content__wrapper">
                            <div class="mobile-content">
                                ...
                                <img class="mobile-vision__image" src="/img/image__mobile/routeIphone.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="wrapper">
                        ...
                        <div class="howConnect-feedback">
                            <h6 class="howConnect-feedback__title--homeVideo howConnect-feedback--homeVideo"><?= Yii::t('site', 'Залишилися питання по підключенню?')?></h6>
                            <p class="howConnect-feedback__text howConnect-feedback--homeVideo"><?= Yii::t('site', 'Зателефонуйте ') . '<a class="feedback-numb">0 800 201 222</a>' . Yii::t('site', 'або') .
